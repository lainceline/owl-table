			...
			switch (props.column.type) {
				...
				case 'checkbox':
					input = React.createElement("label", {className: "owl-check-label"}, 
								React.createElement("input", {ref: "checkbox", className: "owl-input", type: "checkbox", onChange: self.handleSpecialFields, value: "Y", defaultChecked:  props.value ? true : false})
							);
					break;
				case 'radio':
