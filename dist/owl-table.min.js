	...
	var OwlInput = React.createClass({
		...
		render: function () {
			...
			switch (props.column.type) {
				...
				case 'date':
					input =
						React.createElement("input", {className: "owl-input", onChange: self.transmitSaveEvent, defaultValue: props.value, 'data-date-format': "dd-M-yy", 'data-provide': "datepicker"});
					break;
				case 'time':
...
var OwlCell = React.createClass({
	...
	render: function () {
		...
		if (props.editable === true) {
			...
			td = React.createElement("td", {'data-field': props.column.field, dangerouslySetInnerHTML: { __html: value}});
		}
