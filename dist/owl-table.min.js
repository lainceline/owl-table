			...
			switch (props.column.type) {
				...
				case 'select_multiple':
					...
					if (props.column.type === 'select_multiple') {
						input = React.createElement("select", {onChange: self.inputDidChange, className: "swiftbox", multiple: true, defaultValue: props.value.split("||")}, 
									optionList
								);
					} else {
				...
				case 'date':
					input =
						React.createElement("input", {onChange: self.transmitSaveEvent, defaultValue: props.value, 'data-provide': "datepicker"});
					break;
				case 'time':
					input = React.createElement("input", {type: "time", onChange: self.transmitSaveEvent, defaultValue: props.value});
					break;
				case 'file':
...
var OwlCell = React.createClass({
	...
	render: function () {
		var props = this.props;
		var td;
		var content = React.createElement("span", {className: "owl-cell-value-label", dangerouslySetInnerHTML: {__html: props.row[props.column.field]}});
