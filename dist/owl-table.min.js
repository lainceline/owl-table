			...
			switch (props.column.type) {
				...
				case 'select_multiple':
					...
					if (props.column.type === 'select_multiple') {
						input = React.createElement("select", {onChange: self.handleSpecialFields, className: "swiftbox", multiple: true, defaultValue:  !props.value ? props.value : props.value.split("||")}, 
									optionList
								);
					} else {
