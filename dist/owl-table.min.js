	...
	render: function () {
		...
		var cells = props.columns.map(function (column, index) {
			...
			if (column.visible !== false) {
				return (
					React.createElement(OwlCell, {column: column, row: props.data, editable: editable, focusedCell: state.focusedCell, key: index, tableDidChange: props.tableDidChange})
				);
			}
		});
