...
var OwlTableReact = React.createClass({
	...
	render: function () {
			...
			var colFilters = column.filters.map(function (filter, index) {
				return (
					React.createElement("span", null, 
						React.createElement("div", {className: "owl-filter-button owl-filter-button-add"}), 
						React.createElement("input", {type: "text", defaultValue: "foo"})
					)
				);
			});

			return (
				React.createElement("th", {className: "tacky-top"}, 
		...
		return (
			React.createElement("table", {onKeyUp: self.keyup, className: "owl-table tacky"}, 
