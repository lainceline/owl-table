...
var OwlCell = React.createClass({
	...
	render: function () {
		...
		if (props.editable === true) {
			...
			td =
				React.createElement("td", {className: props.column.field, 'data-field': props.column.field}, 
					content
				);
		} else {
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/columnModal.html',
    '<div class="modal-header"><h3 class="modal-title">Customize Columns</h3></div><div class="modal-body"><li ng-repeat="column in columns"><a ng-click="toggleColumn(column)">{{ column.title }}</a></li></div><div class="modal-footer"><button ng-click="ok()" class="btn btn-primary">Ok</button></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/customizeColumns.html',
    '<span class="owl-customize-columns"><button ng-click="owlCtrl.owlTable.customizeColumns()" class="btn btn-lg">Foo</button></span>');
}]);
})();
