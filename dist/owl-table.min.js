		...
		render: function () {
			...
			switch (props.column.type) {
				...
				case 'select_multiple':
					...
					input = React.createElement("select", {onChange: self.transmitSaveEvent, value: props.value}, 
								optionList
							);
					break;
				case 'radio':
						...
						return (
							React.createElement("div", {key: index, className: "radio"}, 
								React.createElement("label", null, 
									React.createElement("input", {type: "radio", onChange: self.transmitSaveEvent, value: option.value, name: radioName}), 
									option.text
								)
							)
						);
...
var OwlRow = React.createClass({
	...
	render: function () {
		...
		var cells = props.columns.map(function (column, index) {
			return (
				React.createElement(OwlCell, {column: column, row: props.data, focusedCell: state.focusedCell, open: props.open || state.open, key: index, tableDidChange: props.tableDidChange})
			);
		});
