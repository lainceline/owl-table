...
b=React.createElement("div",null,b);break;case "date":b=React.createElement("input",{className:"owl-input",defaultValue:a.value,"data-date-format":"mm/dd/yyyy","data-provide":"datepicker"});break;case "time":b=React.createElement("input",{className:"owl-input",type:"time",onChange:c.handleSpecialFields,defaultValue:a.value});break;case "file":b=React.createElement("span",null," File upload not supported yet ");break;case "log":b=React.createElement("span",null," Log field not supported yet ");break;
