	...
	render: function () {
		...
		if (props.massUpdate) {
			massUpdateHeaders = props.columns.map(function (column, index) {
				return React.createElement("th", {key: index, className: "tacky-top", 'data-field': column.field}, " ", column.field, " ");
			});
			...
			massUpdateRow = props.columns.map(function (column, index) {
				return (
					React.createElement("td", {key: index, className: "tacky-top", 'data-field': column.field}, 
						React.createElement(OwlInput, {
		...
		return (
			React.createElement("table", {onKeyUp: self.keyup, id: "owl-table", className: classes}, 
				React.createElement("thead", null, 
					React.createElement("tr", null, massUpdateHeaders), 
					React.createElement("tr", null, massUpdateRow), 
					filterSection, 
