		...
		render: function () {
			...
			switch (props.column.type) {
				...
				case 'select_multiple':
					...
					break;
				case 'checkbox':
					input = React.createElement("div", {className: "form-inline"}, 
						React.createElement("div", {className: "checkbox"}, 
							React.createElement("label", null, 
								React.createElement("input", {className: "owl-input", type: "checkbox", onChange: self.transmitSaveEvent, defaultValue: "Y"}), " Yes"
							)
						));
					break;
				case 'radio':
				...
				case 'date':
					input =
						React.createElement("input", {className: "owl-input", onChange: self.transmitSaveEvent, defaultValue: props.value, 'data-provide': "datepicker"});
					break;
				case 'time':
					input = React.createElement("input", {className: "owl-input", type: "time", onChange: self.transmitSaveEvent, defaultValue: props.value});
					break;
				case 'file':
...
var OwlCell = React.createClass({
	...
	render: function () {
		...
		if (props.column.type.indexOf('select') > -1) {
			...
			content = React.createElement("span", {className: "owl-cell-value-label", dangerouslySetInnerHTML: {__html: optionText}});
		} else {
			content = React.createElement("span", {className: "owl-cell-value-label", dangerouslySetInnerHTML: {__html: props.row[props.column.field]}});
		}
		...
		if (props.editable === true) {
			...
			td = React.createElement("td", {'data-field': props.column.field, dangerouslySetInnerHTML: {__html: props.row[props.column.field]}});
		}
